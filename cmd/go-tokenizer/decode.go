...
func init() { register(newDecodeCmd) }

func newDecodeCmd(o *options) *cobra.Command {
...
given as a JSON array (e.g. "9906 4435", "9906,4435", or "[9906, 4435]").`,
	...
	cmd.Flags().BoolVarP(&decodeNoNewline, "no-newline", "n", false, "do not print a trailing newline")
	return cmd
}

// parseIDs extracts integer token IDs from a free-form string, tolerating
// whitespace, comma, and JSON-array separators.
